...
import { idlFactory } from './motoko_coin.did.js';
export { idlFactory } from './motoko_coin.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MOTOKO_COIN_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./motoko_coin.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the motoko_coin canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./motoko_coin.did.js")._SERVICE>}
 */
export const motoko_coin = createActor(canisterId);
