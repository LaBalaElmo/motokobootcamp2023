...
import { idlFactory } from './student_wall.did.js';
export { idlFactory } from './student_wall.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.STUDENT_WALL_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./student_wall.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the student_wall canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./student_wall.did.js")._SERVICE>}
 */
export const student_wall = createActor(canisterId);
